				...
				<div class="col-lg-6 col-7">
					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">Apagar Correspondente</li>
						</ol>
					</nav>
				</div>
        ...
        <div class="col">
          	<div class="card">
				...
				<div class="card-header">
					...
					<form id="form_correspondentes" class="form-horizontal" method="post" action="<?php echo current_url(); ?>">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<label class="bmd-label-floating">Nome do Correspondente</label>
									<input type="text" disabled="" value="<?php echo set_value("nome_correspondente", @$item->nome_correspondente); ?>" class="form-control" name="nome_correspondente" id="nome_correspondente">
									<?php echo form_error('nome_correspondente'); ?>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" disabled="" value="<?php echo set_value("email_correspondente", @$item->email); ?>" class="form-control" name="email_correspondente" id="email_correspondente">
									<?php echo form_error('email_correspondente'); ?>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
								<label class="bmd-label-floating">Telefone do Correspondente</label>
									<input type="text" disabled="" value="<?php echo set_value("telefone_telefone", @$item->telefone); ?>" class="form-control" name="telefone_correspondente" id="telefone_correspondente">
									<?php echo form_error('telefone_correspondente'); ?>
								</div>
							</div>
						</div>
