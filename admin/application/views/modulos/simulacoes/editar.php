	...
	<div class="row">
        <div class="col">
          	<div class="card">
				...
				<div class="card-header">
					<form id="form_simulacoes" class="form-horizontal" method="post" action="<?php echo site_url('simulacoes/editar/'). $item->id; ?>" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-2">
								...
								<br>
								<label class="custom-toggle">
									<input type="checkbox" name="imovel" <?php if(@$item->imovel == "on") { echo "checked"; }  ?>>
									<span class="custom-toggle-slider rounded-circle" data-label-off="Não" data-label-on="Sim"></span>
								</label>
							</div>
							<div class="col-md-3">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea id="observacoes" name="observacoes"><?php echo set_value("observacoes", @$item->observacoes); ?></textarea>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<a href="<?php echo site_url().'simulacoes'?>" class="btn btn-sm">Cancelar</a>
								</div>
							</div>
						</div>
					</form>
