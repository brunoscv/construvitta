	...
	<div class="row">
        <div class="col">
          	<div class="card">
				...
				<div class="card-header">
					<form id="form_simulacoes" class="form-horizontal">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<label class="bmd-label-floating">Nome do Corretor</label>
									<?php echo form_dropdown('corretores_id', $listaCorretores, set_value('corretores_id', @$item->corretores_id), 'data-size="7" data-live-search="true" class="form-control fill_select btn_in own_selectbox" disabled="" id="corretor"'); ?>
							...
							<div class="col-md-6">
								...
								<label class="bmd-label-floating">Nome do Cliente</label>
									<?php echo form_dropdown('clientes_id', $listaClientes, set_value('clientes_id', @$item->clientes_id), 'data-size="7" data-live-search="true" class="form-control fill_select btn_in own_selectbox" disabled="" id="cliente"'); ?>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" value="<?php echo set_value("email_cliente", @$item->email); ?>" class="form-control" name="email" id="email_cliente" disabled="">
							...
							<div class="col-md-3">
								...
								<label class="bmd-label-floating">Telefone do Cliente</label>
									<input type="text" value="<?php echo set_value("telefone_cliente", @$item->telefone); ?>" class="form-control" name="telefone" id="telefone" disabled="">
							...
							<div class="col-md-3">
								...
								<label class="bmd-label-floating">Data de Nascimento</label>
									<input type="text" value="<?php echo set_value("data_nasc", @$item->data_nasc); ?>" class="form-control datepicker" name="data_nasc" id="data_nasc" disabled="">
						...
						<div class="row">
							<div class="col-md-2">
								...
								<br>
								<label class="custom-toggle">
									<input type="checkbox" name="imovel" <?php if(@$item->imovel == "on") { echo "checked"; }  ?> disabled="">
									<span class="custom-toggle-slider rounded-circle" data-label-off="Não" data-label-on="Sim"></span>
								</label>
							</div>
							<div class="col-md-3">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea id="observacoes" name="observacoes" disabled=""><?php echo set_value("observacoes", @$item->observacoes); ?></textarea>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<a href="<?php echo site_url().'simulacoes'?>" class="btn btn-primary btn-sm">Voltar</a>
								</div>
							</div>
						</div>
					</form>
