						...
						<div class="row">
							<div class="col-md-6">
								...
								<label class="bmd-label-floating">Nome do Imobiliária</label>
									<input type="text" value="<?php echo set_value("nome_imobiliaria", @$item->nome_imobiliaria); ?>" class="form-control" name="nome_imobiliaria" id="nome_imobiliaria">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" value="<?php echo set_value("cnpj", @$item->cnpj); ?>" class="form-control" name="cnpj" id="cnpj">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" value="<?php echo set_value("creci", @$item->creci); ?>" class="form-control" name="creci" id="creci">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" value="<?php echo set_value("email_imobiliaria", @$item->email); ?>" class="form-control" name="email_imobiliaria" id="email_imobiliaria">
							...
							<div class="col-md-6">
								...
								<label class="bmd-label-floating">Telefone do Imobiliária</label>
									<input type="text" value="<?php echo set_value("telefone_telefone", @$item->telefone); ?>" class="form-control" name="telefone_imobiliaria" id="telefone_imobiliaria">
