...
<head>
  ...
  <meta name="description" content=" Construvitta">
        ...
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>" class="nav-link">
              <span class="nav-link-inner--text"> Construvitta</span>
            </a>
          </li>
        </ul>
        <hr class="d-lg-none" />
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form class="m-t-md" action="<?php echo current_url(); ?>" method="post">
                ...
                <div class="text-center">
                  <button type="submit" value="enviar" class="btn bg-darkred my-4 btn-block">Entrar</button>
                </div>
              </form>
            </div>
          </div>
      ...
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          <div class="copyright text-center text-xl-left text-white">
            &copy; <?= date("Y")?> <a href="#" class="font-weight-bold ml-1" target="_blank" style="color: #fff !important">Construvitta</a>
          </div>
        </div>
      </div>
    </div>
