						...
						<div class="row">
							<div class="col-md-2">
								...
								<label class="bmd-label-floating">Tem Muro?</label>
									<select name="casa_muro" id="" class="form-control">
										...
										<option value="on" <?php if(@$casa_muro == "on") { echo "selected"; } ?>>Sim</option>
									</select>
								</div>
							</div>
							<div class="col-md-3">
								...
								<label class="bmd-label-floating">Tem Cerca Elétrica?</label>
									<select name="cerca_eletrica" id="" class="form-control">
										<option value="">Selecione</option>
										<option value="on" <?php if(@$cerca_eletrica == "on") { echo "selected"; } ?>>Sim</option>
									</select>
								</div>
							</div>
							<div class="col-md-3">
								...
								<label class="bmd-label-floating">Tem Portão Automático?</label>
									<select name="portao_automatico" id="" class="form-control">
										<option value="">Selecione</option>
										<option value="on" <?php if(@$portao_automatico == "on") { echo "selected"; } ?>>Sim</option>
									</select>
								</div>
							</div>
							<div class="col-md-2">
							...
							<div class="col-md-2">
								<div class="form-group">
                                    ...
                                    <a href="<?= site_url('clientes-contratos/buscar');?>" class="btn btn-sm" style="padding: .54em 1em; margin-top: .45em; ">Limpar</a>
								</div>
							</div>
						</div>
