				...
				<div class="col-lg-6 col-7">
					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">Ver Cliente com Contratos</li>
						</ol>
					</nav>
				</div>
				...
				<div class="card-header">
					...
					<div class="row">
						...
						<div class="col-md-2">
							...
							<br>
							<label class="custom-toggle">
								<input type="checkbox" name="contrato" checked="checked" disabled="">
								<span class="custom-toggle-slider rounded-circle" data-label-off="Não" data-label-on="Sim"></span>
							</label>
						</div>
						<div class="col-md-2">
					...
					<div class="row">
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="text" value="<?php echo set_value("valor_lote", @$item->valor_lote); ?>" class="form-control" name="valor_lote" id="valor_lote" disabled="">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<input type="text" value="<?php echo set_value("valor_casa", @$item->valor_casa); ?>" class="form-control" name="valor_casa" id="valor_casa" disabled="">
						...
						<div class="col-md-3">
							...
							<label class="bmd-label-floating">Qual Extra?</label>
								<input type="text" value="<?php echo set_value("extra", @$item->extra); ?>" class="form-control" name="extra" id="extra" disabled="">
						...
						<div class="col-md-1 mb-3">
							...
							<br>
							<label class="custom-toggle">
								<input type="checkbox" name="muro" <?php if(@$item->muro == "on") { echo "checked"; }  ?> disabled="">
								<span class="custom-toggle-slider rounded-circle" data-label-off="Não" data-label-on="Sim"></span>
							</label>
						</div>
						<div class="col-md-2 mb-3">
							...
							<br>
							<label class="custom-toggle">
								<input type="checkbox" name="cerca_eletrica" <?php if(@$item->cerca_eletrica == "on") { echo "checked"; }  ?> disabled="">
								<span class="custom-toggle-slider rounded-circle" data-label-off="Não" data-label-on="Sim"></span>
							</label>
						</div>
						<div class="col-md-2 mb-3">
							...
							<br>
							<label class="custom-toggle">
								<input type="checkbox" name="portao_automatico" <?php if(@$item->portao_automatico == "on") { echo "checked"; }  ?> disabled="">
								<span class="custom-toggle-slider rounded-circle" data-label-off="Não" data-label-on="Sim"></span>
							</label>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<a href="<?php echo site_url().'clientes-contratos'?>" class="btn btn-sm btn-primary">Voltar</a>
							</div>
						</div>
					</div>
				</div>
