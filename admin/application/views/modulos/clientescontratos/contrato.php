				...
				<div class="col-lg-6 col-7">
					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">Editar Cliente com Contrato</li>
						</ol>
					</nav>
				</div>
				<div class="col-lg-6 col-5 text-right">
					<a href="<?= base_url()?>clientes-contratos" class="btn btn-sm btn-neutral"><i class="fa fa-list"></i> Lista de Clientes com Contrato</a>
	...
	<div class="row">
        <div class="col">
          	<div class="card">
				...
				<div class="card-header">
					<form id="form_clientes" class="form-horizontal" method="post" action="<?php echo site_url("clientes-contratos/contrato/" . $item->id); ?>" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-3 mb-3">
								...
								<label class="custom-toggle">
									...
									<input type="checkbox" name="compr_dependente" <?php if(@$item->compr_dependente == "on") { echo "checked"; }  ?>>
							...
							<div class="col-md-5 mb-3">
								...
								<br>
								<label class="custom-toggle">
									<input type="checkbox" name="fgts" <?php if(@$item->fgts == "on") { echo "checked"; }  ?>>
									<span class="custom-toggle-slider rounded-circle" data-label-off="Não" data-label-on="Sim"></span>
								</label>
							</div>
							<div class="col-md-2">
						...
						<div class="row">
							...
							<div class="col-md-3 mb-3">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="custom-control custom-checkbox mb-3">
											<input class="custom-control-input" name="c0" value="1" id="customCheck1" type="checkbox" <?php if(@$item->c0 == "1") { echo "checked"; }  ?>>
											<label class="custom-control-label" for="customCheck1">C0</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="custom-control custom-checkbox mb-3">
											<input class="custom-control-input" name="c0_s" value="1" id="customCheck2" type="checkbox" <?php if(@$item->c0_s == "1") { echo "checked"; }  ?>>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="custom-control custom-checkbox mb-3">
											<input class="custom-control-input" name="c1" value="1" id="customCheck3" type="checkbox" <?php if(@$item->c1 == "1") { echo "checked"; }  ?>>
											<label class="custom-control-label" for="customCheck3">C1</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="custom-control custom-checkbox mb-3">
											<input class="custom-control-input" name="c2" value="1" id="customCheck4" type="checkbox" <?php if(@$item->c2 == "1") { echo "checked"; }  ?>>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="custom-control custom-checkbox mb-3">
											<input class="custom-control-input" name="c3" value="1" id="customCheck5" type="checkbox" <?php if(@$item->c3 == "1") { echo "checked"; }  ?>>
											<label class="custom-control-label" for="customCheck5">C3</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="custom-control custom-checkbox mb-3">
											<input class="custom-control-input" name="c4" value="1" id="customCheck6" type="checkbox" <?php if(@$item->c4 == "1") { echo "checked"; }  ?>>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="custom-control custom-checkbox mb-3">
											<input class="custom-control-input" name="c5" value="1" id="customCheck7" type="checkbox" <?php if(@$item->c5 == "1") { echo "checked"; }  ?>>
											<label class="custom-control-label" for="customCheck7">C5</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="custom-control custom-checkbox mb-3">
											<input class="custom-control-input" name="com_muro" value="1" id="customCheck8" type="checkbox" <?php if(@$item->com_muro == "1") { echo "checked"; }  ?>>
                                    ...
                                    <?php foreach ($cliente_arquivos as $key => $arquivo) { ?>
                                        <li class='list-group-item px-0'>
                                            <div class='row align-items-center'>
                                                ...
                                                <div class='col-auto'>
                                                    <a href='#' role='button' aria-haspopup='true' aria-expanded='false' data-toggle="modal" data-target="#modal-notification" data-arquivoid="<?= $arquivo->id ?>">
