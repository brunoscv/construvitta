				...
				<div class="col-lg-6 col-7">
					...
					<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
						<ol class="breadcrumb breadcrumb-links breadcrumb-dark">
							...
							<li class="breadcrumb-item active" aria-current="page">Novo Corretor</li>
						</ol>
					</nav>
				</div>
						...
						<div class="row">
							<div class="col-md-6">
								...
								<label class="bmd-label-floating">Nome do Corretor</label>
									<input type="text" value="<?php echo set_value("nome_corretor", @$item->nome_corretor); ?>" class="form-control" name="nome_corretor" id="nome_corretor">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" value="<?php echo set_value("email_corretor", @$item->email); ?>" class="form-control" name="email_corretor" id="email_corretor">
							...
							<div class="col-md-4">
								...
								<label class="bmd-label-floating">Telefone do Corretor</label>
									<input type="text" value="<?php echo set_value("telefone_corretor", @$item->telefone); ?>" class="form-control" name="telefone_corretor" id="telefone_corretor">
